...
$path_to_module =  '/Users/maxit/Sites/drupal/modules/'.drush_get_option('widget-path', "test-widget");
drush_print('linking widget named '.$widget_name.' to path '.$path_to_module);
(symlink($path_to_module, $widget_name)) ? 'linking widget named '.$widget_name.' to path '.$path_to_module : "***ERROR: didn't like to".$path_to_module;
...
$path_to_library =  '../modules/designssquare_com_blog/libraries/jwplayer';
