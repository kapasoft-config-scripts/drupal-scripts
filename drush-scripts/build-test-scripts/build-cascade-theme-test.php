...
$theme_name = 'bazar';
$ver = '0.2';
$package_name = 'designssquare-com-cascade-theme';
...
//build cascade_theme module
$widget_name = 'cascade_theme';
drush_print('build '.$widget_name.' module ...');
$widget_path = $module_dir.$widget_name;
drush_shell_exec('sudo cp -R '.$widget_path.'/ '.$dest.'/modules/cascade_theme');
print_r(drush_shell_exec_output());
...
drush_shell_exec('sudo cp -R '.$widget_path.'/ '.$dest.'/theme/cascade');
print_r(drush_shell_exec_output());
